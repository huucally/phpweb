...
$pdo->exec('CREATE TABLE `users_ahyun` (
...
$pdo->exec('DROP TABLE IF EXISTS '.$visitdb.';');


$pdo->exec('CREATE TABLE `tb_stat_visit_ahyun` (
...
$createAdmin = $pdo->prepare('INSERT INTO '.$usersdb.'
	(username, usernumber, password, is_admin, activate, salt) VALUES
    ("admin","123456", :password, 1, 1, :salt)');
